		...
		<view class="spellcon">
			...
			<view class="spell_list">
				<view class="spell_item">
					<view class="label">
						<image src="/static/images/icon_times.png" style="width:32rpx;height: 32rpx;"></image>
						<text class="text">时间</text>
					</view>
					<view class="content">
						<view class="input">
							<input type="text" v-model="from.time" class="inputs" placeholder="请输入时间" placeholder-style="color: #848484;" />
						</view>
				...
				<view class="spell_item">
					<view class="label">
						<image src="/static/images/icon_start.png" style="width:32rpx;height: 36rpx;"></image>
						<text class="text">起点</text>
					</view>
					<view class="content">
						<input v-model="from.start" type="text" class="inputs" placeholder="请输入起点" placeholder-style="color: #848484;" />
				...
				<view class="spell_item">
					<view class="label">
						<image src="/static/images/icon_end.png" style="width:32rpx;height: 32rpx;"></image>
						<text class="text">终点</text>
					</view>
					<view class="content">
						<input v-model="from.end" type="text" class="inputs" placeholder="请输入终点" placeholder-style="color: #848484;" />
			...
			<view class="btn_group">
				<view class="commbtn" @click="onSubmit">发布拼车</view>
		...
		methods:{
			...
			onMod(index){
				if(index===1){
					...
					this.modtitle = "终点";
					this.modcon = "温馨提示：请在输入栏输入您正确的目的地，方便与你联系";
				}else if(index===5){
					this.modtitle = "描述";
					this.modcon = "温馨提示：请在输入栏输入您正确的描述信息，方便与你联系";
				}else if(index===6){
					this.modtitle = "备注";
					this.modcon = "温馨提示：请在此栏目输入重要提示，方便用户查阅浏览哦；";
				}
			...
			onSubmit(){
				...
				let data = {
					...
					pinche_time:this.from.time,
					description:this.from.desc,
					remark:this.from.remark,
					start_location:this.from.start,
					end_location:this.from.end,
