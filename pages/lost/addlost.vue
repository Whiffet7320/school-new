	...
	<view>
		<view class="spellcon">
			...
			<view class="spell_list">
				<view class="spell_item">
					<view class="label">
						...
						<text class="text">失物</text>
					</view>
					<view class="content">
						<input v-model="from.name" type="text" class="inputs" placeholder="请输入失物名称" placeholder-style="color: #848484;" />
				...
				<view class="spell_item">
					...
					<view class="content">
						<input v-model="from.remark" type="text" class="inputs" placeholder="请输入备注" />
			...
			<view class="btn_group">
				<view class="commbtn" @click="onSubmit">发布寻物</view>
		...
		methods:{
			...
			onMod(index){
				if(index===1){
					...
					this.modtitle = "物品描述";
					this.modcon = "宝贝详情可填写你丢失的物品的品牌，规格，大概价位，颜色等，描述的越详细，更能让拾主更快的联系你；";
				}else if(index===4){
					this.modtitle = "备注";
